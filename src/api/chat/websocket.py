    ...
    try:
        while True:
            ...
            if event_type == "new_message":
                ...
                response = message_schema.model_dump()
            ...
            if event_type == "message_read":
                ...
                response = {"event_type": "message_read", "message_id": data.get("message_id")}
                await connection_manager.broadcast(chat_id, response)
