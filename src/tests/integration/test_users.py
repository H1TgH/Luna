...
@pytest.mark.asyncio
async def test_register_user_with_empty_payload(client: AsyncClient, user_auth_payload):
    response = await client.post("/api/v1/users/auth/register", json=user_auth_payload(email="", password=""))
...
@pytest.mark.asyncio
async def test_login_user_empty_payload(client: AsyncClient, user_auth_payload):
    response = await client.post("/api/v1/users/auth/login", json=user_auth_payload(email="", password=""))
